...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\reidb\\PsychoPy\\Test Experiments\\3_9_2024_Test_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trial = data.Routine(
        name='trial',
        components=[Fixation_Point, Cue, Stimulus, key_resp, text],
    )

...
expName = '3_9_2024_Test'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\reidb\\PsychoPy\\Test Experiments\\3_9_2024_Test.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Cue = visual.ShapeStim(
        win=win, name='Cue',
        size=(0.05, 0.05), vertices='circle',
        ori=0.0, pos=(-0.65,0.4), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='black', fillColor='black',
    ...
    Stimulus = visual.GratingStim(
        ...
        ori=0.0, pos=(-.2, .2), draggable=False, size=(0.1, 0.1), sf=10.0, phase=0.0,
    ...
    trial = data.Routine(
        name='trial',
        components=[Fixation_Point, Cue, Stimulus],
    )
    ...
    while continueRoutine:
        ...
        if Fixation_Point.status == STARTED:
            ...
            if tThisFlipGlobal > Fixation_Point.tStartRefresh + 1.2-frameTolerance:
        ...
        if Stimulus.status == NOT_STARTED and tThisFlip >= 1.1-frameTolerance:
            # keep track of start time/frame for later

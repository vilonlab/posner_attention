...
from questplus import psychometric_function_patched 
...
class QuestPlus:
    ...
    def _gen_likelihoods(self) -> xr.DataArray:
        ...
        if self.func == "weibull":
            f = psychometric_function_patched.weibull
        elif self.func == "csf":
            f = psychometric_function_patched.csf
        elif self.func == "norm_cdf":
            f = psychometric_function_patched.norm_cdf
        elif self.func == "norm_cdf_2":
            f = psychometric_function_patched.norm_cdf_2
        elif self.func == "thurstone_scaling":
            f = psychometric_function_patched.thurstone_scaling_function
        elif self.func == "csf_log_parabola":
            f = psychometric_function_patched.csf_log_parabola
        elif self.func == "csf_log_parabola_fwhm":
            f = psychometric_function_patched.csf_log_parabola_fwhm
